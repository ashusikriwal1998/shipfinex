    ...
    <div>
      <div className='bg-white px-[306px] py-[60px] max-sm:px-[20px] max-sm:py-[28px]'>
        ...
        <p className='text-[17px] text-[#878787] 3xl:text-[32px] text-justify'>
          Welcome to Shipfinex FZCO, a pioneering force in transforming the shipping industry through our state-of-the-art Software as a Service (SaaS) platform, meticulously engineered on cutting-edge blockchain technology.
          <br /><br />
